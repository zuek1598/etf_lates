...
TECHNICAL = {
    'kama': {
        ...
        'fast_ema': 2,          # Fast EMA period
        'slow_ema': 30,         # Slow EMA period
        'epsilon': 0.0001       # Small value to prevent division by zero
    },
    'stochastic': {
        'period': 14,           # Stochastic period
        'oversold': 20,         # < 20 = oversold zone
        'overbought': 80,       # > 80 = overbought zone
        'signal_period': 3      # %D signal line period
    },
    'vwap': {
    ...
    'roc': {
        'period': 20            # Rate of Change period
    },
    'rsi': {
        'period': 14,           # RSI period (if still used)
        'oversold': 30,
        'overbought': 70
    }
}

# Stochastic scoring thresholds
STOCHASTIC_SCORING = {
    'strong_buy': (20, 40, 20),     # Zone 20-40 = strong buy signal, +20 points
    'buy': (40, 60, 10),            # Zone 40-60 = buy signal, +10 points
    'neutral': (60, 80, 5),         # Zone 60-80 = neutral, +5 points
    'extreme': 0                     # < 20 or > 80 = extreme, 0 points
}
...
VALIDATION = {
    ...
    'thresholds': {
        'acceptable_mae': 0.08,     # 8% MAE threshold for good forecast
...
FORECAST_QUALITY = {
    'mae_thresholds': {
        'excellent': 0.03,          # < 3% MAE
        'good': 0.06,               # 3-6% MAE
        'fair': 0.12,               # 6-12% MAE
        'poor': 0.25                # 12-25% MAE, > 25% = very poor
    },
    'hit_rate_thresholds': {
